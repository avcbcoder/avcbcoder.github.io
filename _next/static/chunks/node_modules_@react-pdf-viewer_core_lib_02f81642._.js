...
"[project]/node_modules/@react-pdf-viewer/core/lib/cjs/core.js [client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
'use strict';
var React = __turbopack_context__.r("[project]/node_modules/react/index.js [client] (ecmascript)");
var PdfJsApi = __turbopack_context__.r("[project]/node_modules/pdfjs-dist/build/pdf.js [client] (ecmascript)");
...
var useIntersectionObserver = function(props) {
    ...
    useIsomorphicLayoutEffect({
        "useIntersectionObserver.useIsomorphicLayoutEffect": function() {
            var container = containerRef.current;
            if (!container) {
                return;
            }
            var intersectionTracker = new IntersectionObserver({
                "useIntersectionObserver.useIsomorphicLayoutEffect": function(entries) {
                    entries.forEach({
                        "useIntersectionObserver.useIsomorphicLayoutEffect": function(entry) {
                    ...
                    }["useIntersectionObserver.useIsomorphicLayoutEffect"]);
                }
            }["useIntersectionObserver.useIsomorphicLayoutEffect"], {
...
var Menu = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "Menu.useIsomorphicLayoutEffect": function() {
            var container = containerRef.current;
            if (!container) {
                return;
            }
    ...
    }["Menu.useIsomorphicLayoutEffect"], []);
    useIsomorphicLayoutEffect({
        "Menu.useIsomorphicLayoutEffect": function() {
...
var TextBox = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "TextBox.useIsomorphicLayoutEffect": function() {
            if (autoFocus) {
    ...
    }["TextBox.useIsomorphicLayoutEffect"], []);
...
var useDebounceCallback = function(callback, wait) {
    ...
    return React__namespace.useCallback({
        "useDebounceCallback.useCallback": function() {
            ...
            }["useDebounceCallback.useCallback"], wait);
        }
...
var useIsMounted = function() {
    ...
    React__namespace.useEffect({
        "useIsMounted.useEffect": function() {
...
var useRenderQueue = function(_a) {
    ...
    var initialPageVisibilities = React__namespace.useMemo({
        "useRenderQueue.useMemo[initialPageVisibilities]": function() {
            return Array(numPages).fill(null).map({
                "useRenderQueue.useMemo[initialPageVisibilities]": function(_, pageIndex) {
                    return {
                        pageIndex: pageIndex,
            ...
            }["useRenderQueue.useMemo[initialPageVisibilities]"]);
        }
    }["useRenderQueue.useMemo[initialPageVisibilities]"], [
        docId
    ]);
...
var useLockScroll = function() {
    React__namespace.useEffect({
        "useLockScroll.useEffect": function() {
...
var ModalBody = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "ModalBody.useIsomorphicLayoutEffect": function() {
    ...
    }["ModalBody.useIsomorphicLayoutEffect"], []);
    return React__namespace.createElement("div", {
        "aria-modal": "true",
        className: classNames({
...
var usePosition = function(contentRef, targetRef, anchorRef, position, offset) {
    useIsomorphicLayoutEffect({
        "usePosition.useIsomorphicLayoutEffect": function() {
    ...
    }["usePosition.useIsomorphicLayoutEffect"], []);
};
...
var PopoverBody = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "PopoverBody.useIsomorphicLayoutEffect": function() {
    ...
    }["PopoverBody.useIsomorphicLayoutEffect"], []);
...
var PopoverOverlay = function(_a) {
    ...
    var containerRef = React__namespace.useRef();
    useEscape({
        "PopoverOverlay.useEscape": function() {
            if (containerRef.current && closeOnEscape) {
                onClose();
            }
        }
    }["PopoverOverlay.useEscape"]);
    return React__namespace.createElement("div", {
...
var Popover = function(_a) {
    ...
    var controlsSuffix = React__namespace.useMemo({
        "Popover.useMemo[controlsSuffix]": function() {
            return ariaControlsSuffix || "".concat(uniqueId());
        }
    }["Popover.useMemo[controlsSuffix]"], []);
    return React__namespace.createElement("div", {
        ref: targetRef,
        "aria-expanded": opened ? 'true' : 'false',
...
var Tooltip = function(_a) {
    ...
    var contentRef = React__namespace.useRef();
    var controlsSuffix = React__namespace.useMemo({
        "Tooltip.useMemo[controlsSuffix]": function() {
            return ariaControlsSuffix || "".concat(uniqueId());
        }
    }["Tooltip.useMemo[controlsSuffix]"], []);
    useEscape({
        "Tooltip.useEscape": function() {
...
var chunk = function(arr, size) {
    return arr.reduce(function(acc, e, i) {
        return i % size ? acc[acc.length - 1].push(e) : acc.push([
            e
        ]), acc;
    }, []);
};
...
var useRunOnce = function(cb, condition) {
    ...
    useIsomorphicLayoutEffect({
        "useRunOnce.useIsomorphicLayoutEffect": function() {
            if (condition && !isCalledRef.current) {
                isCalledRef.current = true;
                cb();
            }
        }
    }["useRunOnce.useIsomorphicLayoutEffect"], [
        cb,
        condition
    ]);
};
var useTrackResize = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "useTrackResize.useIsomorphicLayoutEffect": function() {
            var io = new ResizeObserver({
                "useTrackResize.useIsomorphicLayoutEffect": function(entries) {
                    entries.forEach({
                        "useTrackResize.useIsomorphicLayoutEffect": function(entry) {
                            onResize(entry.target);
                        }
                    }["useTrackResize.useIsomorphicLayoutEffect"]);
                }
            }["useTrackResize.useIsomorphicLayoutEffect"]);
...
var PopupWrapper = function(_a) {
    ...
    React__namespace.useLayoutEffect({
        "PopupWrapper.useLayoutEffect": function() {
...
var AnnotationLayerBody = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "AnnotationLayerBody.useIsomorphicLayoutEffect": function() {
            var container = containerRef.current;
            if (!container) {
                return;
            }
            plugins.forEach({
                "AnnotationLayerBody.useIsomorphicLayoutEffect": function(plugin) {
            ...
            }["AnnotationLayerBody.useIsomorphicLayoutEffect"]);
        }
    }["AnnotationLayerBody.useIsomorphicLayoutEffect"], []);
    return React__namespace.createElement("div", {
        ref: containerRef,
...
var AnnotationLoader = function(_a) {
    ...
    React__namespace.useEffect({
        "AnnotationLoader.useEffect": function() {
            page.getAnnotations({
                intent: 'display'
            }).then({
                "AnnotationLoader.useEffect": function(result) {
...
var floatToRatio = function(x, limit) {
    ...
    while(true){
        ...
        value <= numerator / denominator ? (_a = [
            numerator,
            denominator
        ], c = _a[0], d = _a[1], _a) : (_b = [
            numerator,
...
var CanvasLayer = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "CanvasLayer.useIsomorphicLayoutEffect": function() {
            ...
            plugins.forEach({
                "CanvasLayer.useIsomorphicLayoutEffect": function(plugin) {
            ...
            }["CanvasLayer.useIsomorphicLayoutEffect"]);
            var viewport = page.getViewport({
                rotation: rotation,
                scale: scale
            });
            ...
            var transform = shouldScaleByCSS || outputScale !== 1 ? [
                possibleScale,
                0,
                0,
                possibleScale,
...
var SvgLayer = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "SvgLayer.useIsomorphicLayoutEffect": function() {
            var containerEle = containerRef.current;
            var viewport = page.getViewport({
                rotation: rotation,
                scale: scale
            ...
            page.getOperatorList().then({
                "SvgLayer.useIsomorphicLayoutEffect": function(operatorList) {
                    empty();
                    var graphic = new PdfJsApi__namespace.SVGGraphics(page.commonObjs, page.objs);
                    graphic.getSVG(operatorList, viewport).then({
                        "SvgLayer.useIsomorphicLayoutEffect": function(svg) {
                            svg.style.height = "".concat(height, "px");
                            svg.style.width = "".concat(width, "px");
                            containerEle.appendChild(svg);
                        }
                    }["SvgLayer.useIsomorphicLayoutEffect"]);
                }
            }["SvgLayer.useIsomorphicLayoutEffect"]);
        }
    }["SvgLayer.useIsomorphicLayoutEffect"], []);
...
var TextLayer = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "TextLayer.useIsomorphicLayoutEffect": function() {
            var task = renderTask.current;
            if (task) {
                task.cancel();
            }
            ...
            plugins.forEach({
                "TextLayer.useIsomorphicLayoutEffect": function(plugin) {
            ...
            }["TextLayer.useIsomorphicLayoutEffect"]);
            page.getTextContent().then({
                "TextLayer.useIsomorphicLayoutEffect": function(textContent) {
                    empty();
                    ...
                    renderTask.current.promise.then({
                        "TextLayer.useIsomorphicLayoutEffect": function() {
                            ...
                            spans.forEach({
                                "TextLayer.useIsomorphicLayoutEffect": function(span) {
...
var useMeasureRect = function(_a) {
    ...
    var _c = React__namespace.useReducer(rectReducer, {
        height: 0,
        width: 0
    }), rect = _c[0], dispatch = _c[1];
    useIsomorphicLayoutEffect({
        "useMeasureRect.useIsomorphicLayoutEffect": function() {
            if (elementRef.current !== element) {
                setElement(elementRef.current);
            }
        }
    }["useMeasureRect.useIsomorphicLayoutEffect"]);
    useIsomorphicLayoutEffect({
        "useMeasureRect.useIsomorphicLayoutEffect": function() {
    ...
    React__namespace.useEffect({
        "useMeasureRect.useEffect": function() {
            if (!element) {
                return;
            }
            var tracker = new ResizeObserver({
                "useMeasureRect.useEffect": function(entries, __) {
                    entries.forEach({
                        "useMeasureRect.useEffect": function(entry) {
...
var useScroll = function(_a) {
    ...
    var handleSmoothScrollingComplete = React__namespace.useCallback({
        "useScroll.useCallback[handleSmoothScrollingComplete]": function() {
    ...
    }["useScroll.useCallback[handleSmoothScrollingComplete]"], []);
    var handleScroll = React__namespace.useCallback({
        "useScroll.useCallback[handleScroll]": function() {
            if (!element) {
                return;
            }
    ...
    }["useScroll.useCallback[handleScroll]"], [
        element
    ]);
    useIsomorphicLayoutEffect({
    ...
    var scrollTo = React__namespace.useCallback({
        "useScroll.useCallback[scrollTo]": function(targetPosition, withSmoothScroll) {
            ...
            if (withSmoothScroll) {
                ...
                onSmoothScroll(true);
                return new Promise({
                    "useScroll.useCallback[scrollTo]": function(resolve, _) {
                        smoothScroll(ele, latestRef.current, updatePosition, SCROLL_DURATION, easeOutQuart, {
                            "useScroll.useCallback[scrollTo]": function() {
                                handleSmoothScrollingComplete();
                                resolve();
                            }
                        }["useScroll.useCallback[scrollTo]"]);
                    }
                }["useScroll.useCallback[scrollTo]"]);
            }
            return new Promise({
...
var useVirtual = function(_a) {
    ...
    var onSmoothScroll = React__namespace.useCallback({
        "useVirtual.useCallback[onSmoothScroll]": function(isSmoothScrolling) {
            return setSmoothScrolling(isSmoothScrolling);
        }
    }["useVirtual.useCallback[onSmoothScroll]"], []);
    ...
    var defaultVisibilities = React__namespace.useMemo({
        "useVirtual.useMemo[defaultVisibilities]": function() {
            return Array(numberOfItems).fill(-1);
        }
    }["useVirtual.useMemo[defaultVisibilities]"], []);
    var _d = React__namespace.useState(defaultVisibilities), visibilities = _d[0], setVisibilities = _d[1];
    var intersectionTracker = React__namespace.useMemo({
        "useVirtual.useMemo[intersectionTracker]": function() {
            var io = new IntersectionObserver({
                "useVirtual.useMemo[intersectionTracker]": function(entries) {
                    entries.forEach({
                        "useVirtual.useMemo[intersectionTracker]": function(entry) {
                            ...
                            if (0 <= index && index < numberOfItems) {
                                setVisibilities({
                                    "useVirtual.useMemo[intersectionTracker]": function(old) {
                                        old[index] = ratio;
                                        return __spreadArray([], old, true);
                                    }
                                }["useVirtual.useMemo[intersectionTracker]"]);
                            }
                        }
                    }["useVirtual.useMemo[intersectionTracker]"]);
                }
    ...
    var measurements = React__namespace.useMemo({
    ...
    var _e = React__namespace.useMemo({
        "useVirtual.useMemo[_e]": function() {
    ...
    }["useVirtual.useMemo[_e]"], [
        measurements,
        parentRect,
        scrollOffset,
        viewMode,
        visibilities
    ]), startPage = _e.startPage, endPage = _e.endPage, maxVisbilityIndex = _e.maxVisbilityIndex;
    var virtualItems = React__namespace.useMemo({
        "useVirtual.useMemo[virtualItems]": function() {
            var virtualItems = [];
            var _loop_1 = {
                "useVirtual.useMemo[virtualItems]._loop_1": function(i) {
                    var item = measurements[i];
                    var virtualItem = __assign(__assign({}, item), {
                        visibility: visibilities[i] !== undefined ? visibilities[i] : -1,
                        measureRef: {
                            "useVirtual.useMemo[virtualItems]._loop_1.virtualItem": function(ele) {
                                if (!ele) {
                                    return;
                                }
                        ...
                        }["useVirtual.useMemo[virtualItems]._loop_1.virtualItem"]
                    });
                    virtualItems.push(virtualItem);
                }
            }["useVirtual.useMemo[virtualItems]._loop_1"];
    ...
    var scrollToItem = React__namespace.useCallback({
        "useVirtual.useCallback[scrollToItem]": function(index, offset) {
    ...
    }["useVirtual.useCallback[scrollToItem]"], [
        scrollTo,
        enableSmoothScroll
    ]);
    var scrollToSmallestItemAbove = React__namespace.useCallback({
        "useVirtual.useCallback[scrollToSmallestItemAbove]": function(index, offset) {
            var measurements = latestRef.current.measurements;
            var start = measurements[index].start;
            var nextItem = measurements.find({
                "useVirtual.useCallback[scrollToSmallestItemAbove].nextItem": function(item) {
                    return item.start.top - start.top > COMPARE_EPSILON;
                }
            }["useVirtual.useCallback[scrollToSmallestItemAbove].nextItem"]);
            if (!nextItem) {
                return Promise.resolve();
            }
    ...
    }["useVirtual.useCallback[scrollToSmallestItemAbove]"], []);
    var scrollToBiggestItemBelow = React__namespace.useCallback({
        "useVirtual.useCallback[scrollToBiggestItemBelow]": function(index, offset) {
            var measurements = latestRef.current.measurements;
            var start = measurements[index].start;
            var prevIndex = index;
            var found = false;
    ...
    }["useVirtual.useCallback[scrollToBiggestItemBelow]"], []);
    var scrollToNextItem = React__namespace.useCallback({
        "useVirtual.useCallback[scrollToNextItem]": function(index, offset) {
    ...
    }["useVirtual.useCallback[scrollToNextItem]"], []);
    var scrollToPreviousItem = React__namespace.useCallback({
        "useVirtual.useCallback[scrollToPreviousItem]": function(index, offset) {
            if (viewModeRef.current === exports.ViewMode.DualPageWithCover || viewModeRef.current === exports.ViewMode.DualPage) {
    ...
    }["useVirtual.useCallback[scrollToPreviousItem]"], []);
    var getContainerStyles = React__namespace.useCallback({
        "useVirtual.useCallback[getContainerStyles]": function() {
            return buildContainerStyles(totalSize, scrollModeRef.current);
        }
    }["useVirtual.useCallback[getContainerStyles]"], [
        totalSize
    ]);
    var getItemContainerStyles = React__namespace.useCallback({
        "useVirtual.useCallback[getItemContainerStyles]": function(item) {
            return buildItemContainerStyles(item, parentRect, scrollModeRef.current);
        }
    }["useVirtual.useCallback[getItemContainerStyles]"], [
        parentRect
    ]);
    var getItemStyles = React__namespace.useCallback({
        "useVirtual.useCallback[getItemStyles]": function(item) {
            return buildItemStyles(item, isRtl, sizes, viewModeRef.current, scrollModeRef.current);
        }
    }["useVirtual.useCallback[getItemStyles]"], [
        isRtl,
        sizes
    ]);
    var zoom = React__namespace.useCallback({
        "useVirtual.useCallback[zoom]": function(scale, index) {
    ...
    }["useVirtual.useCallback[zoom]"], []);
    React__namespace.useEffect({
        "useVirtual.useEffect": function() {
            return ({
                "useVirtual.useEffect": function() {
                    intersectionTracker.disconnect();
                }
            })["useVirtual.useEffect"];
        }
    }["useVirtual.useEffect"], []);
    return {
...
var useDestination = function(_a) {
    ...
    var markVisitedDestination = React__namespace.useCallback({
        "useDestination.useCallback[markVisitedDestination]": function(destination) {
            previousDestinations.push(destination);
        }
    }["useDestination.useCallback[markVisitedDestination]"], []);
    return {
...
var useOutlines = function(doc) {
    ...
    React__namespace.useEffect({
        "useOutlines.useEffect": function() {
            doc.getOutline().then({
                "useOutlines.useEffect": function(result) {
                    if (isMounted.current && result !== null) {
                        var items = flaternOutlines(result);
                        setOutlines(items);
                    }
                }
            }["useOutlines.useEffect"]);
        }
    }["useOutlines.useEffect"], []);
    return outlines;
};
...
var useWindowResize = function() {
    ...
    var handleResize = useDebounceCallback({
        "useWindowResize.useDebounceCallback[handleResize]": function() {
            setWindowRect({
                height: window.innerHeight,
                width: window.innerWidth
            });
        }
    }["useWindowResize.useDebounceCallback[handleResize]"], 100);
    useIsomorphicLayoutEffect({
        "useWindowResize.useIsomorphicLayoutEffect": function() {
            ...
            })["useWindowResize.useIsomorphicLayoutEffect"];
        }
    }["useWindowResize.useIsomorphicLayoutEffect"], []);
    return windowRect;
};
...
var useFullScreen = function(_a) {
    ...
    useIsomorphicLayoutEffect({
        "useFullScreen.useIsomorphicLayoutEffect": function() {
            if (targetRef.current !== element) {
                setElement(targetRef.current);
            }
        }
    }["useFullScreen.useIsomorphicLayoutEffect"], []);
    useIsomorphicLayoutEffect({
        "useFullScreen.useIsomorphicLayoutEffect": function() {
            if (!element) {
                return;
            ...
            var io = new ResizeObserver({
                "useFullScreen.useIsomorphicLayoutEffect": function(entries) {
                    entries.forEach({
                        "useFullScreen.useIsomorphicLayoutEffect": function(entry) {
    ...
    var closeOtherFullScreen = React__namespace.useCallback({
        "useFullScreen.useCallback[closeOtherFullScreen]": function(target) {
    ...
    }["useFullScreen.useCallback[closeOtherFullScreen]"], []);
    var enterFullScreenMode = React__namespace.useCallback({
        "useFullScreen.useCallback[enterFullScreenMode]": function(target) {
            if (!target || !isFullScreenEnabled()) {
                return;
            }
            setElement(target);
            closeOtherFullScreen(target).then({
                "useFullScreen.useCallback[enterFullScreenMode]": function() {
                    fullScreenElementRef.current = target;
                    setFullScreenMode(exports.FullScreenMode.Entering);
                    requestFullScreen(target);
                }
            }["useFullScreen.useCallback[enterFullScreenMode]"]);
        }
    }["useFullScreen.useCallback[enterFullScreenMode]"], []);
    var exitFullScreenMode = React__namespace.useCallback({
        "useFullScreen.useCallback[exitFullScreenMode]": function() {
            var currentFullScreenEle = getFullScreenElement();
    ...
    }["useFullScreen.useCallback[exitFullScreenMode]"], []);
    var handleFullScreenChange = React__namespace.useCallback({
        "useFullScreen.useCallback[handleFullScreenChange]": function() {
            if (!element) {
                return;
            }
            var currentFullScreenEle = getFullScreenElement();
    ...
    }["useFullScreen.useCallback[handleFullScreenChange]"], [
        element
    ]);
    React__namespace.useEffect({
...
var Inner = function(_a) {
    ...
    var destinationManager = useDestination({
        getCurrentPage: {
            "Inner.useDestination[destinationManager]": function() {
                return stateRef.current.pageIndex;
            }
        }["Inner.useDestination[destinationManager]"]
    });
    ...
    var fullScreen = useFullScreen({
        getCurrentPage: {
            "Inner.useFullScreen[fullScreen]": function() {
                return stateRef.current.pageIndex;
            }
        }["Inner.useFullScreen[fullScreen]"],
        ...
        jumpToPage: {
            "Inner.useFullScreen[fullScreen]": function(pageIndex) {
    ...
    var layoutBuilder = React__namespace.useMemo({
        "Inner.useMemo[layoutBuilder]": function() {
            return Object.assign({}, DEFAULT_PAGE_LAYOUT, pageLayout);
        }
    }["Inner.useMemo[layoutBuilder]"], []);
    var sizes = React__namespace.useMemo({
        "Inner.useMemo[sizes]": function() {
            return Array(numPages).fill(0).map({
                "Inner.useMemo[sizes]": function(_, pageIndex) {
                    var pageSize = [
    ...
    var handlePagesResize = useDebounceCallback({
        "Inner.useDebounceCallback[handlePagesResize]": function() {
    ...
    }["Inner.useDebounceCallback[handlePagesResize]"], 200);
    useTrackResize({
        targetRef: pagesRef,
    ...
    var handleJumpFromLinkAnnotation = React__namespace.useCallback({
        "Inner.useCallback[handleJumpFromLinkAnnotation]": function(destination) {
            destinationManager.markVisitedDestination(destination);
        }
    }["Inner.useCallback[handleJumpFromLinkAnnotation]"], []);
    var handleJumpToDestination = React__namespace.useCallback({
        "Inner.useCallback[handleJumpToDestination]": function(destination) {
            ...
            return new Promise({
                "Inner.useCallback[handleJumpToDestination]": function(resolve, _) {
                    getPage(doc, pageIndex).then({
                        "Inner.useCallback[handleJumpToDestination]": function(page) {
                            var viewport = page.getViewport({
                                scale: 1
                            });
                            var top = 0;
                            ...
                            switch(currentState.scrollMode){
                                case exports.ScrollMode.Horizontal:
                                    virtualizer.scrollToItem(pageIndex, {
                                        ...
                                        "Inner.useCallback[handleJumpToDestination]": function() {
                                            resolve();
                                        }
                                    }["Inner.useCallback[handleJumpToDestination]"]);
                                    break;
                                case exports.ScrollMode.Vertical:
                                default:
                                    virtualizer.scrollToItem(pageIndex, {
    ...
    var jumpToDestination = React__namespace.useCallback({
        "Inner.useCallback[jumpToDestination]": function(destination) {
            destinationManager.markVisitedDestination(destination);
            return handleJumpToDestination(destination);
        }
    }["Inner.useCallback[jumpToDestination]"], []);
    var jumpToNextDestination = React__namespace.useCallback({
        "Inner.useCallback[jumpToNextDestination]": function() {
    ...
    }["Inner.useCallback[jumpToNextDestination]"], []);
    var jumpToPreviousDestination = React__namespace.useCallback({
        "Inner.useCallback[jumpToPreviousDestination]": function() {
    ...
    }["Inner.useCallback[jumpToPreviousDestination]"], []);
    var jumpToNextPage = React__namespace.useCallback({
        "Inner.useCallback[jumpToNextPage]": function() {
            return virtualizer.scrollToNextItem(stateRef.current.pageIndex, ZERO_OFFSET);
        }
    }["Inner.useCallback[jumpToNextPage]"], []);
    var jumpToPage = React__namespace.useCallback({
        "Inner.useCallback[jumpToPage]": function(pageIndex) {
            return 0 <= pageIndex && pageIndex < numPages ? virtualizer.scrollToItem(pageIndex, ZERO_OFFSET) : Promise.resolve();
        }
    }["Inner.useCallback[jumpToPage]"], []);
    var jumpToPreviousPage = React__namespace.useCallback({
        "Inner.useCallback[jumpToPreviousPage]": function() {
            return virtualizer.scrollToPreviousItem(stateRef.current.pageIndex, ZERO_OFFSET);
        }
    }["Inner.useCallback[jumpToPreviousPage]"], []);
    var openFile = React__namespace.useCallback({
        "Inner.useCallback[openFile]": function(file) {
            if (getFileExt(file.name).toLowerCase() !== 'pdf') {
                return;
            }
            new Promise({
                "Inner.useCallback[openFile]": function(resolve) {
                    var reader = new FileReader();
                    reader.readAsArrayBuffer(file);
                    reader.onload = ({
                        "Inner.useCallback[openFile]": function() {
                            var bytes = new Uint8Array(reader.result);
                            resolve(bytes);
                        }
                    })["Inner.useCallback[openFile]"];
                }
            }["Inner.useCallback[openFile]"]).then({
                "Inner.useCallback[openFile]": function(data) {
    ...
    var rotate = React__namespace.useCallback({
        "Inner.useCallback[rotate]": function(direction) {
    ...
    }["Inner.useCallback[rotate]"], []);
    var rotatePage = React__namespace.useCallback({
        "Inner.useCallback[rotatePage]": function(pageIndex, direction) {
            var degrees = direction === exports.RotateDirection.Backward ? -90 : 90;
            ...
            setPagesRotationChanged({
                "Inner.useCallback[rotatePage]": function(value) {
                    return !value;
                }
            }["Inner.useCallback[rotatePage]"]);
            setViewerState(__assign(__assign({}, stateRef.current), {
    ...
    var switchScrollMode = React__namespace.useCallback({
        "Inner.useCallback[switchScrollMode]": function(scrollMode) {
            setViewerState(__assign(__assign({}, stateRef.current), {
                scrollMode: scrollMode
            }));
            setCurrentScrollMode(scrollMode);
        }
    }["Inner.useCallback[switchScrollMode]"], []);
    var switchViewMode = React__namespace.useCallback({
        "Inner.useCallback[switchViewMode]": function(viewMode) {
            setViewerState(__assign(__assign({}, stateRef.current), {
                viewMode: viewMode
            }));
            setCurrentViewMode(viewMode);
        }
    }["Inner.useCallback[switchViewMode]"], []);
    var zoom = React__namespace.useCallback({
        "Inner.useCallback[zoom]": function(newScale) {
            ...
            setRenderQueueKey({
                "Inner.useCallback[zoom]": function(key) {
                    return key + 1;
                }
            }["Inner.useCallback[zoom]"]);
            renderQueue.markNotRendered();
    ...
    var enterFullScreenMode = React__namespace.useCallback({
        "Inner.useCallback[enterFullScreenMode]": function(target) {
            fullScreen.enterFullScreenMode(target);
        }
    }["Inner.useCallback[enterFullScreenMode]"], []);
    var exitFullScreenMode = React__namespace.useCallback({
        "Inner.useCallback[exitFullScreenMode]": function() {
            fullScreen.exitFullScreenMode();
        }
    }["Inner.useCallback[exitFullScreenMode]"], []);
    React__namespace.useEffect({
        "Inner.useEffect": function() {
            setViewerState(__assign(__assign({}, stateRef.current), {
    ...
    React__namespace.useEffect({
        "Inner.useEffect": function() {
            ...
            plugins.forEach({
                "Inner.useEffect": function(plugin) {
                    if (plugin.install) {
    ...
    useRunOnce({
        "Inner.useRunOnce": function() {
            if (initialPage) {
                jumpToPage(initialPage);
            }
        }
    }["Inner.useRunOnce"], boundingClientRect.height > 0 && boundingClientRect.width > 0);
    useIsomorphicLayoutEffect({
        "Inner.useIsomorphicLayoutEffect": function() {
            ...
            if (latestPage > -1 && previousScrollMode !== currentScrollMode) {
                ...
                }["Inner.useIsomorphicLayoutEffect"]);
            }
        }
    }["Inner.useIsomorphicLayoutEffect"], [
        currentScrollMode
    ...
    useIsomorphicLayoutEffect({
        "Inner.useIsomorphicLayoutEffect": function() {
            ...
            var _loop_1 = {
                "Inner.useIsomorphicLayoutEffect._loop_1": function(i) {
                    var item = virtualItems.find({
                        "Inner.useIsomorphicLayoutEffect._loop_1.item": function(item) {
                            return item.index === i;
                        }
                    }["Inner.useIsomorphicLayoutEffect._loop_1.item"]);
                    if (item) {
                        renderQueue.setVisibility(i, item.visibility);
                    }
                }
            }["Inner.useIsomorphicLayoutEffect._loop_1"];
            for(var i = startPage; i <= endPage; i++){
                _loop_1(i);
            }
            renderNextPage();
    ...
    React__namespace.useEffect({
        "Inner.useEffect": function() {
            ...
            renderQueue.setRange(startPage, endPage);
            var _loop_2 = {
                "Inner.useEffect._loop_2": function(i) {
                    var item = virtualItems.find({
                        "Inner.useEffect._loop_2.item": function(item) {
                            return item.index === i;
                        }
                    }["Inner.useEffect._loop_2.item"]);
                    if (item) {
                        renderQueue.setVisibility(i, item.visibility);
                    }
                }
            }["Inner.useEffect._loop_2"];
            for(var i = startPage; i <= endPage; i++){
                _loop_2(i);
            }
            renderNextPage();
    ...
    var handlePageRenderCompleted = React__namespace.useCallback({
        "Inner.useCallback[handlePageRenderCompleted]": function(pageIndex) {
            renderQueue.markRendered(pageIndex);
            renderNextPage();
        }
    }["Inner.useCallback[handlePageRenderCompleted]"], [
        renderQueueKey
    ]);
    ...
    var renderViewer = React__namespace.useCallback({
        "Inner.useCallback[renderViewer]": function() {
            ...
            switch(currentViewMode){
                ...
                case exports.ViewMode.DualPageWithCover:
                    if (virtualItems.length) {
                        ...
                        ].concat(chunk(virtualItems.slice(1), 2)) : chunk(virtualItems, 2);
                    }
                    break;
                case exports.ViewMode.SinglePage:
                default:
            ...
            var slot = {
                ...
                subSlot: {
                    ...
                    children: React__namespace.createElement("div", {
                        ...
                        "Inner.useCallback[renderViewer]": function(items) {
                            return React__namespace.createElement("div", {
                                className: classNames({
                                ...
                                "Inner.useCallback[renderViewer]": function(item) {
                            ...
                            }["Inner.useCallback[renderViewer]"]));
                        }
                    }["Inner.useCallback[renderViewer]"]))
                }
            };
            plugins.forEach({
                "Inner.useCallback[renderViewer]": function(plugin) {
    ...
    var renderSlot = React__namespace.useCallback({
        "Inner.useCallback[renderSlot]": function(slot) {
...
var PageSizeCalculator = function(_a) {
    ...
    React__namespace.useLayoutEffect({
        "PageSizeCalculator.useLayoutEffect": function() {
            var queryPageSizes = Array(doc.numPages).fill(0).map({
                "PageSizeCalculator.useLayoutEffect.queryPageSizes": function(_, i) {
                    return new Promise({
                        "PageSizeCalculator.useLayoutEffect.queryPageSizes": function(resolve, _) {
                            getPage(doc, i).then({
                                "PageSizeCalculator.useLayoutEffect.queryPageSizes": function(pdfPage) {
                            ...
                            }["PageSizeCalculator.useLayoutEffect.queryPageSizes"]);
                        }
                    }["PageSizeCalculator.useLayoutEffect.queryPageSizes"]);
                }
            }["PageSizeCalculator.useLayoutEffect.queryPageSizes"]);
            Promise.all(queryPageSizes).then({
                "PageSizeCalculator.useLayoutEffect": function(pageSizes) {
                    var pagesEle = pagesRef.current;
            ...
            }["PageSizeCalculator.useLayoutEffect"]);
        }
    }["PageSizeCalculator.useLayoutEffect"], [
...
var AskingPassword = function(_a) {
    ...
    React__namespace.useEffect({
        "AskingPassword.useEffect": function() {
...
var DocumentLoader = function(_a) {
    ...
    var isMounted = useIsMounted();
    React__namespace.useEffect({
        "DocumentLoader.useEffect": function() {
            docRef.current = '';
            ...
            loadingTask.onPassword = ({
                "DocumentLoader.useEffect": function(verifyPassword, reason) {
                    switch(reason){
            ...
            })["DocumentLoader.useEffect"];
            loadingTask.onProgress = ({
                "DocumentLoader.useEffect": function(progress) {
...
var withTheme = function(theme, onSwitchTheme) {
    var initialTheme = React__namespace.useMemo({
        "withTheme.useMemo[initialTheme]": function() {
            return theme === 'auto' ? isDarkMode() ? 'dark' : 'light' : theme;
        }
    }["withTheme.useMemo[initialTheme]"], []);
    ...
    React__namespace.useEffect({
        "withTheme.useEffect": function() {
            if (theme !== 'auto') {
                return;
            }
            var media = window.matchMedia('(prefers-color-scheme: dark)');
            var handler = {
                "withTheme.useEffect.handler": function(e) {
                    setCurrentTheme(e.matches ? 'dark' : 'light');
                }
            }["withTheme.useEffect.handler"];
...
var Viewer = function(_a) {
    var characterMap = _a.characterMap, defaultScale = _a.defaultScale, _b = _a.enableSmoothScroll, enableSmoothScroll = _b === void 0 ? true : _b, fileUrl = _a.fileUrl, _c = _a.httpHeaders, httpHeaders = _c === void 0 ? {} : _c, _d = _a.initialPage, initialPage = _d === void 0 ? 0 : _d, pageLayout = _a.pageLayout, _e = _a.initialRotation, initialRotation = _e === void 0 ? 0 : _e, localization = _a.localization, _f = _a.plugins, plugins = _f === void 0 ? [] : _f, renderError = _a.renderError, renderLoader = _a.renderLoader, renderPage = _a.renderPage, renderProtectedView = _a.renderProtectedView, _g = _a.scrollMode, scrollMode = _g === void 0 ? exports.ScrollMode.Vertical : _g, _h = _a.setRenderRange, setRenderRange = _h === void 0 ? DEFAULT_RENDER_RANGE : _h, transformGetDocumentParams = _a.transformGetDocumentParams, _j = _a.theme, theme = _j === void 0 ? {
        direction: exports.TextDirection.LeftToRight,
        theme: 'light'
    } : _j, _k = _a.viewMode, viewMode = _k === void 0 ? exports.ViewMode.SinglePage : _k, _l = _a.withCredentials, withCredentials = _l === void 0 ? false : _l, onDocumentAskPassword = _a.onDocumentAskPassword, _m = _a.onDocumentLoad, onDocumentLoad = _m === void 0 ? function() {} : _m, _o = _a.onPageChange, onPageChange = _o === void 0 ? function() {} : _o, _p = _a.onRotate, onRotate = _p === void 0 ? function() {} : _p, _q = _a.onRotatePage, onRotatePage = _q === void 0 ? function() {} : _q, _r = _a.onSwitchTheme, onSwitchTheme = _r === void 0 ? function() {} : _r, _s = _a.onZoom, onZoom = _s === void 0 ? function() {} : _s;
...
"[project]/node_modules/@react-pdf-viewer/core/lib/index.js [client] (ecmascript)": (function(__turbopack_context__) {
...
if ("TURBOPACK compile-time falsy", 0) {
    ...
    module.exports = __turbopack_context__.r("[project]/node_modules/@react-pdf-viewer/core/lib/cjs/core.js [client] (ecmascript)");
}
}}),
}]);

//# sourceMappingURL=node_modules_%40react-pdf-viewer_core_lib_02f81642._.js.map